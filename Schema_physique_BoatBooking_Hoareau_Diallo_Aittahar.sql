...
CREATE TABLE CLIENT (
    ...
    CL_EMAIL VARCHAR(100) NOT NULL constraint CKC_CL_EMAIL_CLIENT CHECK (CL_EMAIL != CL_SECOND_EMAIL),
    CL_SECOND_EMAIL VARCHAR(100) constraint CKC_CL_SECOND_EMAIL_CLIENT CHECK (CL_SECOND_EMAIL != CL_EMAIL),
    CL_TELEPHONE VARCHAR(10) NOT NULL constraint CKC_CL_TELEPHONE_CLIENT CHECK (length(CL_TELEPHONE) > 9),
